...
public class AnyKeywordsAndAnyStatusCondition extends TaskSearchCondition {
  private final List<String> keywords;
  private final List<Integer> statusIds;

  public AnyKeywordsAndAnyStatusCondition(List<String> keywords, List<Integer> statusIds) {
